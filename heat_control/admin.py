...
class SensorAdmin(admin.ModelAdmin):
    fields = ['type', 'hostname', 'name', 'address', 'freq', 'status', 'gpio', 'rorg',
              'rorg_func', 'rorg_type', 'offset', 'room_name', 'ruleset', 'heater']
    list_display = ('hostname', 'name', 'type', 'freq', 'room_name')


class HeaterAdmin(admin.ModelAdmin):
    fields = ['type', 'hostname', 'name', 'address', 'freq', 'status', 'gpio',
              'mode', 'description', 'controller', 'hysteresis']
