...
DEBUG = False
# Allow internals IPs to have the toolbar displayed
...
DATABASES = {
    'default': {
        ...
        'NAME': 'home_automation',            # Or path to database file if using sqlite3.
        'USER': 'home_automation',            # Not used with sqlite3.
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            '/srv/home_automation/django_templates'
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
